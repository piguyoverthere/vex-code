...
//Left Motors:
motor_group(FLmotor, BLmotor),

//Right Motors:
motor_group(FRmotor, BRmotor),
...
void pre_auton() {
  ...
  while(!auto_started){
    ...
    Brain.Screen.printAt(5, 20, "Liver v1.18");
    Brain.Screen.printAt(5, 30, "#K TEST VERSION by github/piguyoverthere");
...
void debug() {
  ...
  FRmotor.spin(fwd,100,volt);
  wait(1000,msec);
  FRmotor.stop();
  Brain.Screen.clearScreen();
  Brain.Screen.setCursor(1,1);
  Brain.Screen.print("FL motor");
  FLmotor.spin(fwd,100,volt);
  wait(1000,msec);
  FLmotor.stop();
  Brain.Screen.clearScreen();
  Brain.Screen.setCursor(1,1);
  Brain.Screen.print("BR motor");
  BRmotor.spin(fwd,100,volt);
  wait(1000,msec);
  BRmotor.stop();
  Brain.Screen.clearScreen();
  Brain.Screen.setCursor(1,1);
  Brain.Screen.print("BL motor");
  BLmotor.spin(fwd,100,volt);
  wait(1000,msec);
  BLmotor.stop();
  Brain.Screen.clearScreen();
  Brain.Screen.setCursor(1,1);
